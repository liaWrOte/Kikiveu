...
const Cgu = () => (
  <div className="cgu">
    ...
    <h3 className="cgu__subtitle">En vigueur au 20/12/2020</h3>

    <p className="cgu__content">
      ...
      par _______________ et de définir les conditions d’accès et d’utilisation des services
      par « l'Utilisateur ».
    ...
    <p className="cgu__content">
      ...
      restriction des présentes CGU par l’utilisateur. Lors de l'inscription sur le site via
      le Formulaire d’inscription, chaque utilisateur accepte expressément les présentes CGU
      en cochant la case précédant le texte suivant : « Je reconnais avoir lu et compris les
      CGU et je les accepte ». En cas de non-acceptation des CGU stipulées dans le présent
      contrat, l'Utilisateur se doit de renoncer à l'accès des services proposés par le site.
      KikiVeu se réserve le droit de modifier unilatéralement et à tout moment le contenu des
      présentes CGU.
    </p>

    <h2 className="cgu__article">ARTICLE 1 : Les mentions légales</h2>

    <p className="cgu__content">
      L’édition et la direction de la publication du site KikiVeu est assurée par Equipe KikiVeu
      (Sandrine, Jordane, Kévin et Julien), domicilié Ecole O'Clock.
      Numéro de téléphone est _______________
      Adresse e-mail kikiveu.contact@gmail.com.

      L'hébergeur du site KikiVeu est la société Amazon Web Services, dont le siège social est situé
      au 67 Boulevard du Général Leclerc à Clichy (92110), avec le numéro de téléphone :
      01-46-17-10-00.
    </p>

    <h2 className="cgu__article">ARTICLE 2 : Accès au site</h2>
    <p className="cgu__content">
      Le site KikiVeu permet à l'Utilisateur un accès gratuit aux services suivants :
      Le site internet propose les services suivants :
      -Une fois l'utilisateur inscrit, il peut :
      - Créer son profil, le modifier
      - Organiser / participer à des balades canines en utilisant un système de géolocalisation
      - Consulter les profils des chiens disponibles aux alentours de sa zone
      - Entrer en contact avec un autre utilisateur
      ...
      logiciels, connexion Internet, etc.)
      sont à sa charge.
    </p>
    <p className="cgu__content">
      ...
      membre s’engage à fournir des informations sincères et exactes concernant son état civil et
      ses coordonnées, notamment son adresse email. Pour accéder aux services, l’Utilisateur doit
      ...
      délai raisonnable. Tout événement dû à un cas de force majeure ayant pour conséquence
      un dysfonctionnement du site ou serveur et sous réserve de toute interruption ou modification
      en cas de maintenance, n'engage pas la responsabilité de KikiVeu. Dans ces cas, l’Utilisateur
    ...
    <h2 className="cgu__article">ARTICLE 3 : Collecte des données</h2>
    <p className="cgu__content">
    ...
    <h2 className="cgu__article">ARTICLE 4 : Propriété intellectuelle</h2>
    <p className="cgu__content">
    ...
    <h2 className="cgu__article">ARTICLE 5 : Responsabilité</h2>
    <p className="cgu__content">
      Les sources des informations diffusées sur le site KikiVeu sont réputées fiables mais le site ne garantit pas
      ...
      des mises à jour régulières, le site KikiVeu ne peut être tenu responsable de la modification des dispositions
      administratives et juridiques survenant après la publication. De même, le site ne peut être tenue responsable
      ...
      Le site KikiVeu ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur ou
      tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement provenant
      de ce site.
    ...
    <h2 className="cgu__article">ARTICLE 6 : Liens hypertextes</h2>
    <p className="cgu__content">
      Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces liens,
      il sortira du site KikiVeu. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles aboutissent ces
      ...
      par votre navigateur et qui sont nécessaires à l’utilisation du site KikiVeu. Les cookies ne contiennent pas
      ...
      L’information contenue dans les cookies est utilisée pour améliorer le site KikiVeu.
    ...
    <h2 className="cgu__article">ARTICLE 8 : Publication par l’Utilisateur</h2>
    <p className="cgu__content">
      Le site permet aux membres de publier les contenus suivants :
      Création d'un profil, ajout de commentaires, possibilité d'échanger des messages entre utilisateurs, création
      d'une balade.
    ...
    <h2 className="cgu__article">ARTICLE 9 : Droit applicable et juridiction compétente</h2>
    <p className="cgu__content">
